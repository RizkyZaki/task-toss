                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Manajemen Siswa</h3>
                            <div class="nk-block-des text-soft">
                                <p>Daftar semua siswa.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="nk-tb-list is-separate is-medium mb-3">
                                ...
                                @forelse($students as $u)
                                    <div class="nk-tb-item">
                                        <div class="nk-tb-col">
                                            <a href="{{ route('students.show', $u->id) }}">{{ $u->name }}</a>
                                        </div>
                                        <div class="nk-tb-col tb-col-md">{{ $u->email }}</div>
                                        <div class="nk-tb-col tb-col-md">
                                            <a href="{{ route('students.show', $u->id) }}" class="btn btn-sm btn-primary">
                                                <em class="icon ni ni-eye"></em><span>Lihat</span>
                                            </a>
                                            <form action="{{ route('students.destroy', $u->id) }}" method="POST"
                                ...
                                @empty
                                    <div class="nk-tb-item">
                                        <div class="nk-tb-col">Belum ada siswa.</div>
                                    </div>
                                @endforelse
                            </div>
